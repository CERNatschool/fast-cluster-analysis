...
if __name__=="__main__":
    ...
    sim_cluster_size      = []
    sim_cluster_counts    = []
    sim_cluster_radius_u  = []
    sim_cluster_density_u = []

    # Loop over the datafiles and read the data.
    for simfilename in glob.glob(simpath + "/*.txt"):
        ...
        # properties for plotting.
        for b in blob_finder.blob_list:
            sim_cluster_size.append(b.get_size())
            sim_cluster_counts.append(b.get_total_counts())
            sim_cluster_radius_u.append(b.r_u)
            sim_cluster_density_u.append(b.spatial_density_u)
